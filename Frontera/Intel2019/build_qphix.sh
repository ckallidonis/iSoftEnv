...
CC="${PK_CC}" \
    ...
    -Dqdpjit=FALSE \
    -Dtesting=TRUE \
    -DPYTHON_EXECUTABLE=/opt/apps/intel19/python3/3.7.0/bin/python3 \
    -DPYTHON_INCLUDE_DIR=/opt/apps/intel19/python3/3.7.0/include \
    -DPYTHON_LIBRARY=/opt/apps/intel19/python3/3.7.0/lib \
    ${PKG_SRC}
