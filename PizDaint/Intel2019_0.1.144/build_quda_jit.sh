...
PKG_SRC=${QUDA_JIT_SRC}
PKG_INSTALL=${QUDA_JIT_INSTALL}
PKG_DIST=${QUDA_JIT_DIST}

BUILD_TAG=${ENV_PRECISION}-prec
QDP_JIT_QUDA=${QDP_JIT_INSTALL}/${BUILD_TAG}
...
${PK_CMAKE}  \
	...
	-DQUDA_MAGMA=OFF	\
	-DQUDA_QMP=ON \
	-DQUDA_QMPHOME=${QMP_JIT_INSTALL} \
        -DQUDA_QIO=ON \
        -DQUDA_QIOHOME=${QDP_JIT_QUDA} \
        -DQUDA_LIMEHOME=${QDP_JIT_QUDA} \
	-DQUDA_MULTIGRID=ON \
