...
DIST_DIRECTORIES=/gpfswork/rech/ual/uie52up/software/util/iSoftEnv/JeanZay/GCC_8.3.1_OpenMPI_4.0.2_cuda_10.2_Genprop5/directories.sh
...
export PK_CC_SERIAL="${GNU_GCC_DIR}/bin/gcc"
export PK_CXX_SERIAL="${GNU_GCC_DIR}/bin/g++"
...
export LD_LIBRARY_PATH=${LLVM_INSTALL}/lib:${OPENBLAS_INSTALL}/lib:${PK_CUDA_HOME}/nvvm/lib64:${CC_LIBS}:${LD_LIBRARY_PATH}
echo $LD_LIBRARY_PATH


#LLVM
export QDPJIT_HOST_ARCH="NVPTX;X86;XCore"
...
#SuperbBLAS
export SUPERBBLAS_NVCC_FLAGS="-x cu -O3 -std=c++14 -arch=$SM"


# QDP-JIT related variables
export JIT_LDFLAGS="${OMPFLAGS} -L${OPENBLAS_INSTALL}/lib -L${LLVM_INSTALL}/lib -L${PK_CUDA_HOME}/lib64 -L${PK_CUDA_HOME}/nvvm/lib64  -Wl,-rpath=${LLVM_INSTALL}/lib -Wl,-rpath=${PK_CUDA_HOME}/lib64  -Wl,-rpath=${PK_CUDA_HOME}/nvvm/lib64 -Wl,-rpath=${CC_LIBS}"
export JIT_LIBS="-ldl -pthread" # -lmpich -lmpich_gnu_82"
export JIT_INC=""

# CHROMA FLAGS
export CHROMA_LDFLAGS="${JIT_LDFLAGS} -Wl,-zmuldefs"

export CHROMA_LIBS="${OPENBLAS_INSTALL}/lib/libopenblas.a -lcublas -lcudart -fopenmp ${JIT_LIBS}"

# Make
PK_TARGET_JN="1"
export MAKE="make -j ${PK_TARGET_JN}" 
export MAKE_LLVM="make -j1" 
